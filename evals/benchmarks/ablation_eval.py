...
Usage:
    ...
    python evals/benchmarks/ablation_eval.py reports/sre-bench-trials.jsonl \\
...
def _coverage_gaps(arm: str, coverage: Optional[dict[str, Any]]) -> list[str]:
    ...
    if coverage is None:
        return [
            ...
            "evals/benchmarks/ablation_coverage.py and pass --memory-coverage to "
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Corpus-coverage artifact from evals/benchmarks/ablation_coverage.py. "
