...
`src/sre_agent/retrieval_metrics.py` measures the *shape* of every retrieval call
...
the labels come from. `evals/benchmarks/datasets/README.md` forbids invented ones:
...
Usage::
    ...
    python evals/benchmarks/retrieval_eval.py --output /tmp/r.json \\
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser.add_argument("--dataset-root", type=Path, default=Path("evals/benchmarks/datasets"))
