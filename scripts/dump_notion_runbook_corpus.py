...
`scripts/audit_runbook_coverage.py` grades a corpus dump, not Notion itself,
...
Usage:
    python scripts/dump_notion_runbook_corpus.py --out /tmp/corpus.json
    python scripts/dump_notion_runbook_corpus.py --cluster-id <uuid> --out /tmp/corpus.json
"""
