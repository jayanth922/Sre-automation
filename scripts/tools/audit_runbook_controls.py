#!/usr/bin/env python3
"""Negative controls for scripts/tools/audit_runbook_coverage.py.
...
Usage:
    python scripts/tools/audit_runbook_controls.py
    python scripts/tools/audit_runbook_controls.py --runbooks examples/meridian/runbooks
"""
...
DEFAULT_RUNBOOKS = REPO / "examples" / "meridian" / "runbooks"
DEFAULT_CORPUS = (
    REPO / "evals" / "benchmarks" / "datasets" / "v2" / "runbook_corpus_snapshot.json"
)
