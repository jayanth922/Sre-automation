...
edge_mcp_servers/mcp_servers/runbooks_notion/server.py) over a corpus dump
...
Run scripts/audit_runbook_controls.py after changing this file. A pass count
...
Usage:
    python scripts/audit_runbook_coverage.py --corpus <dump.json>
    python scripts/audit_runbook_coverage.py --corpus <dump.json> --format json
...
DATASET_DIR = REPO_ROOT / "benchmarks" / "datasets" / "v2"
...
def _compose_query(*, severity: str = "", service: str = "", alert_name: str = "") -> str:
    """What sre_agent/context_builder.py sends as the search arguments."""
...
class Verdict:
    ...
    def passes(self) -> bool:
        ...
        # benchmarks/structured_grading.py:244 -- so naming one permitted
