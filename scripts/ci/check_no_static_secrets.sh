...
PATTERN='cl_[0-9a-f]{20,}|ghp_[A-Za-z0-9]{20,}|sk-[A-Za-z0-9]{20,}|xoxb-[0-9]{5,}-[A-Za-z0-9-]{10,}|nvapi-[A-Za-z0-9_-]{20,}'
...
if [[ -n "$HITS" ]]; then
  ...
  echo "$HITS" >&2
  echo >&2
  echo "Use runtime fixtures / env vars instead (see evals/benchmarks/fixtures.py)." >&2
  exit 1
fi
