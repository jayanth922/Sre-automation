...
REGISTRY: List[Toolset] = [
    Toolset("kubernetes", "infra", True, "services/edge_mcp_servers/k8s_real (:4000)"),
    Toolset("prometheus", "metrics", True, "services/edge_mcp_servers/prometheus_real (:4001)"),
    Toolset("loki", "logs", True, "services/edge_mcp_servers/loki_real (:4002)"),
    Toolset("github", "code", True, "services/edge_mcp_servers/github_real (:4003, read)"),
    Toolset("runbooks", "runbooks", True, "services/edge_mcp_servers/runbooks_notion (:4004)"),
    Toolset("k8s_executor", "exec", True, "services/edge_mcp_servers/executor_real (:4005)"),
    Toolset("github_exec", "code", True, "services/edge_mcp_servers/github_exec (:4006, revert PRs)"),
