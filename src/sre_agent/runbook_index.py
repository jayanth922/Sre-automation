...
`services/edge_mcp_servers/mcp_servers/runbooks_notion/server.py::search_runbooks` is a
...
deliberately never imports `sre_agent` (see `src/sre_agent/embedding.py`'s
...
Qdrant instance as `src/sre_agent/memory_store.py` — that the Planner queries
