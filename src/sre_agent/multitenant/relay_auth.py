...
Historically every edge MCP server (``services/edge_mcp_servers/mcp_servers/*``)
...
See ``services/edge_mcp_servers/relay_credentials.py`` for the receiving side — kept
...
already applies to ``services/edge_mcp_servers/mcp_servers/runbooks_notion/server.py``,
...
# Must match the constants in services/edge_mcp_servers/relay_credentials.py exactly.
