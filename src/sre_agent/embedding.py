...
services/edge_mcp_servers/mcp_servers/runbooks_notion/server.py, which queries Notion
...
Any services/edge_mcp_servers/mcp_servers/* server that did need its own embedding
