...
20,000-character tool-result cap in ``sre_agent/context_compaction.py``, whose
...
# (20,000) in sre_agent/context_compaction.py, or the elision this module
...
# sre_agent/context_compaction.py: what is absent here is absent from this
