...
def upgrade() -> None:
    ...
    op.add_column(
        "jobs", sa.Column("idempotency_key", sa.String(length=200), nullable=True)
    )
    op.add_column(
        "jobs",
    ...
    op.add_column(
        "jobs", sa.Column("lease_owner", sa.String(length=200), nullable=True)
    )
    op.add_column(
        "jobs",
